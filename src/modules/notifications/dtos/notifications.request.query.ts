...
export const NotificationsRoleQueryDto = extendedZod.object({
  role: extendedZod.enum(['user', 'admin']).optional(),
});

export const ListNotificationssQueryDto = PaginationQueryDto.extend(
  NotificationsRoleQueryDto.shape,
).extend({
